...
public class Cell_Warrior : Cell_Hunter
{
																			...
																			: base(column, row, isAlive)
	{
		...
		_warriorPreyTypes = new List<CellType>
				{
						CellType.Diseased, CellType.Plague, CellType.King, CellType.Rebel,
						CellType.Revolutionary, CellType.Spy, CellType.Savior, CellType.Follower,
						CellType.PlagueRat, CellType.Zombie, CellType.Necromancer,
				};
	}
