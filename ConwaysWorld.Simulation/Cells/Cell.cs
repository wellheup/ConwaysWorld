...
public abstract class Cell
{
	...
	/// <summary>Exact number of living neighbours an empty cell needs to be born (default 3, standard Conway rule).</summary>
	...
	///   <item>Dead with exactly <see cref="BirthNeighbors"/> neighbours → born.</item>
	/// </list>
	/// </summary>
