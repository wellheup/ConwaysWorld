...
public abstract class Cell
{
	...
	{
		if (IsAlive && CellNeighborhood.NumNeighbors < MinLivingNeighbors)  return false;
		if (IsAlive && CellNeighborhood.NumNeighbors <= MaxLivingNeighbors) return true;
		if (IsAlive)                                                         return false;
		if (!IsAlive && CellNeighborhood.NumNeighbors == MinLivingNeighbors) return true;
		return IsAlive;
	}
