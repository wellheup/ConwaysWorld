...
public class Cell_Hunter : Cell_Traveler
{
																																																																																																																																	...
																																																																																																																																	: base(column, row, isAlive)
	{
		...
		PreyTypes = new List<CellType> { CellType.Immortal, CellType.King, CellType.Rebel, CellType.Revolutionary, CellType.Spy, CellType.Savior, CellType.Follower, CellType.PlagueRat, CellType.Zombie, CellType.Necromancer };
		CurrentPrey = null;
	}
