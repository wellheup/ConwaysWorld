...
public partial class Model
{
        ...
        public void MoveCell(int fromCol, int fromRow, int toCol, int toRow)
        {
                ...
                // Always create a fresh cell (age 0, no runtime state) so edit-mode moves are predictable.
                // Zombie is recreated with null Necromancer — it becomes an independent standalone zombie.
